...
FINNHUB_API_TOKEN = os.environ.get("FINNHUB_API_TOKEN", "d292e3pr01qhoen9cd70d292e3pr01qhoen9cd7g")
...
class MarketDataView(APIView):
    def get(self, request):
        ...
        try:
            ...
            headers = {
                'X-Finnhub-Token': FINNHUB_API_TOKEN
            }
            ...
            try:
                ...
                return Response({"error": f"Failed to fetch data from Finnhub: {e2}"}, status=500)